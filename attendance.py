...
window.configure(background="#2D336B")  # Dark theme
...
titl = tk.Label(window, bg="#9f8383", relief=RIDGE, bd=10, font=("Verdana", 30, "bold"))
titl.pack(fill=X)
...
titl = tk.Label(
    window, text="ATMIYA ATTENDANCE SYSTEM", bg="#9f8383", fg="#F4F8D3", font=("Times New Roman", 20, "bold"),
)
titl.place(x=525, y=12)

a = tk.Label(
    window,
    text="Welcome to Atmiya University",
    bg="#2D336B",  # Dark background for the main text
    fg="#F4F8D3",  # Bright yellow text color
    bd=10,
...
label1.image = r
label1.place(x=100, y=270,height=300,width=300)

ai = Image.open("UI_Image/attendance.png")
a = ImageTk.PhotoImage(ai)
label2 = Label(window, image=a)
label2.image = a
label2.place(x=500, y=270,height=300,width=300)

vi = Image.open("UI_Image/verifyy.png")
v = ImageTk.PhotoImage(vi)
label3 = Label(window, image=v)
label3.image = v
label3.place(x=900, y=270,height=300,width=300)
